...
class MockUserDatabase {
    var firstNames: [String] = ["Eugene", "Melissa", "Jennifer", "Samantha", "Christina", "David", "Jacqueline", "Christian", "Carol"]
    var lastNames: [String] = ["Watson", "Cox", "", "Freeman", "Adams", "Trueman", "Turner", "Contreras", "Holland", "May", "Keller"]
